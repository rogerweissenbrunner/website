    ...
    <div className="w-full bg-slate-100 dark:bg-slate-800 p-8 rounded-xl flex flex-col flex-nowrap gap-8">
      ...
      >
        ...
        <label className="font-sans flex flex-col gap-2 font-medium">
          {t('nameLabel')}
          <input
            className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white rounded border border-slate-800 dark:border-slate-400 p-2 focus:outline-none focus:ring-2 focus:ring-slate-500 dark:focus:ring-slate-400"
            name="name"
            type="text"
            required
          />
        ...
        <label className="font-sans flex flex-col gap-2 font-medium">
          {t('messageLabel')}
          <textarea
            className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white rounded border border-slate-800 dark:border-slate-400 p-2 min-h-[100px] focus:outline-none focus:ring-2 focus:ring-slate-500 dark:focus:ring-slate-400"
            name="message"
            required
          />
        </label>
