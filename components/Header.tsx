              ...
              {navItems.map(({ href, labelKey, icon }, index) => (
                <li key={href} className="flex-1 md:flex-none">
                  <Link
                    href={href}
                    locale={locale}
                    className={`nav-click-bounce nav-hover-glow inline-flex w-full justify-center items-center gap-2 px-3 py-3 md:w-auto md:py-2 text-sm transition-colors rounded-none ${
